    ...
    <div class="grid grid-cols-12 justify-center">
        <div class="col-span-10 col-start-2 w-full">
            <div class="border p-3 rounded-lg">
                ...
                <h2 class="mb-2 text-center"> Create Products</h2>
                <hr>
                </div>

                <div class=" gap-2">
                    <form action="<?php echo e(url('product/save')); ?>" enctype="multipart/form-data" method="post" class=" grid">
                        <?php echo csrf_field(); ?>
                    <div>
                        <label for="product_name">Product Name:</label>
                        <input type="text" name="product_name" id='product_name' class="border border-1">
                    </div>

                    <div>
                        <label for="product_price">Product Price:</label>
                        <input type="number" name="product_price" id='product_price' class="border border-1">
                    </div>
