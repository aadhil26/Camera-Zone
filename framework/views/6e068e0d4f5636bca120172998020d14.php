...
<div class="flex-grow"> 
        ...
        <section class="bg-gray-900 text-white ">
            <img src="<?php echo e(asset('images/cover.jpg')); ?>" alt="Cover Image" class="w-full h-auto m-0 p-0">
        </section>
    ...
    <main class="container mx-auto px-4 py-8"> 
        ...
        <section class="my-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-gray-200 p-4 rounded-lg text-center">
                <img src="<?php echo e(asset('images/canonR5.webp')); ?>" alt="Camera" class="mx-auto w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg h-64 object-cover">
            ...
            <div class="bg-gray-200 p-4 rounded-lg text-center">
                <img src="<?php echo e(asset('images/djidrone.png')); ?>" alt="Drone" class="mx-auto w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg h-60 object-cover">
            ...
            <div class="bg-gray-200 p-4 rounded-lg text-center">
                <img src="<?php echo e(asset('images/tripodC.png')); ?>" alt="Tripod" class="mx-auto w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg h-64 object-cover">
        ...
        <section class="my-8 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-gray-200 p-4 rounded-lg text-center">
                    <img src="<?php echo e(asset('images/gopro13.png')); ?>" alt="Product 1" class="mx-auto">
                    <p class="font-bold">GoPro HERO13 Black</p>
                    <p>145 500 LKR</p>
                </div>

                <div class="bg-gray-200 p-4 rounded-lg text-center">
                    <img src="<?php echo e(asset('images/sony85.webp')); ?>" alt="Product 2" class="mx-auto">
                    <p class="font-bold">Sony FE 85mm f/1.4 Lens </p>
                    <p>449 500 LKR</p>
                </div>

                <div class="bg-gray-200 p-4 rounded-lg text-center">
                    <img src="<?php echo e(asset('images/djiosmo.png')); ?>" alt="Product 3" class="mx-auto">
                    <p class="font-bold">DJI Osmo Mobile 6 </p>
                    <p> 48 000 LKR</p>
                </div>

                <div class="bg-gray-200 p-4 rounded-lg text-center">
                    <img src="<?php echo e(asset('images/sonya7ii.webp')); ?>" alt="Product 4" class="mx-auto">
        ...
        <section class="my-8 text-center ">
            ...
            <div class="flex flex-wrap justify-center space-x-4 bg-gray-200 p-4 rounded-lg text-center">
                <img src="<?php echo e(asset('images/canon.png')); ?>" alt="Canon" class="w-26 h-24 object-contain">
                <img src="<?php echo e(asset('images/nikon.png')); ?>" alt="Nikon" class="w-26 h-24 object-contain">
                <img src="<?php echo e(asset('images/sony.png')); ?>" alt="Sony" class="w-26 h-24 object-contain">
                <img src="<?php echo e(asset('images/gopro.png')); ?>" alt="GoPro" class="w-26 h-24 object-contain">
                <img src="<?php echo e(asset('images/dji.png')); ?>" alt="DJI" class="w-26 h-24 object-contain">
                <img src="<?php echo e(asset('images/insta.png')); ?>" alt="Insta360" class="w-26 h-24 object-contain">
